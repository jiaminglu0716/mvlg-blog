...
import { getPageItems, pageBound, pageSize } from "../../../lib/pagination";
...
type CaterpillarPageItemsProps<T> = {
  ...
  PrevItem?: (props: DivProps) => React.ReactElement;
  NextItem?: (props: DivProps) => React.ReactElement;
...
export default function CaterpillarPageItems<T>(
  ...
  const { page, setPage, prevPage, nextPage } = usePageState();
